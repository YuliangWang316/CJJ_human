...
write.table(PC_clone,"PC.txt",sep = "\t")
write.table(DP_clone,"DP.txt",sep = "\t")
write.table(DN_clone,"DN.txt",sep = "\t")
write.table(NB_clone,"NB.txt",sep = "\t")
remove(DN,DN_clone,DP,DP_clone,NB,NB_clone,PC,PC_clone)
SHARE<-read.table("E:/P23042711/venn_result1690698383392661836_NEW.txt",sep = "\t",header = TRUE)
Total$three<-"No_Hit"
Total$two<-"No_Hit"
...
write.table(Total_three,file = "e:/P23042711/Total_three.txt",sep = "\t")
write.table(Total_two,file = "e:/P23042711/Total_two.txt",sep = "\t")
...
clones_three_igphyml = readRDS("e:/clone_three_igphyml.rds")
